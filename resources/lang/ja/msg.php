...
return array (
  ...
  'association_edit_successful' => '関連:name 更新されました',
  'association_delete_successful' => '関連:name 削除されました',
  'association_delete_error' => '関連付けの削除中にエラーが発生しました',
  'association_restored_successful' => '関連:name 復元されました',
  ...
  'club_create_successful' => 'クラブ:name 作成されました',
  'club_edit_successful' => 'クラブ:name 更新されました',
  'club_delete_successful' => 'クラブ:name 削除されました',
  'club_delete_error' => 'クラブの削除中にエラーが発生しました',
  'club_restored_successful' => 'クラブ:name が復元されました',
  'club_restored_error' => 'クラブの復元中にエラーが発生しました',
  'you_dont_own_club' => 'あなたはクラブを所有していません',
  'please_ask_associationPresident' => 'あなたの協会会長にリクエストする',
  'team_create_successful' => 'チーム<:name 作成されました',
  'team_edit_successful' => 'チーム:name を更新しました',
  'team_delete_successful' => 'チーム:name 削除されました',
  'team_delete_error' => 'チームの削除中にエラーが発生しました',
  'team_restored_successful' => 'チーム:name 復元されました',
